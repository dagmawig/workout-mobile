                    ...
                    <ImageBackground
                        ...
                        <View className='justify-center items-center h-full w-full'>
                            ...
                            <View className='w-60 flex-row justify-between items-center mt-10'>
                                <TouchableOpacity><Text className='text-gray-300  text-center italic'>Login</Text></TouchableOpacity>
                                <TouchableOpacity><Text className='text-gray-300 text-center italic'>Forgot Password?</Text></TouchableOpacity>
                            </View>
                        </View>
                    </ImageBackground>
                </View>
